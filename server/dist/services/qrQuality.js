...
exports.calculateQRQuality = calculateQRQuality;
/**
 ...
 */
async function cropContrast(imageBuffer, x, y, width, height) {
    try {
 ...
 */
function moduleSizeScore(width, height) {
 ...
 */
async function calculateQRQuality(imageBuffer, boundingBox) {
